...
import { StatusBar, View, Text, SafeAreaView, Image, ScrollView, FlatList, TouchableOpacity } from "react-native";
...
function OrderHistoryDetailsScreen({ navigation, route }) {
		...
		<View style={orderHistoryDetailsStyles.itemContainer}>
			<View style={orderHistoryDetailsStyles.itemSubContainer}>
				<View style={orderHistoryDetailsStyles.content}>
					...
					<Text style={orderHistoryDetailsStyles.itemInformationText} numberOfLines={2}>
						Side dishes: {item.SideDishes}
					</Text>
		...
		<SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
			...
			<View style={orderHistoryDetailsStyles.container}>
				<View style={orderHistoryDetailsStyles.restaurantContainer}>
					...
					<Image source={route.params.OrderType === "DELIVERY" ? icons.delivery : icons.restaurantTable} resizeMode="contain" style={orderHistoryDetailsStyles.image} />
				</View>
				...
				<View style={{ alignSelf: "flex-start" }}>
					<TouchableOpacity style={orderHistoryDetailsStyles.rateButton} activeOpacity={0.5} onPress={() => navigation.navigate("Rate Object", { Id: route.params.ObjectId })}>
						<Text style={orderHistoryDetailsStyles.buttonText}> Rate </Text>
						<Image
							source={Icons.star}
							resizeMode="contain"
							style={{
