				...
				<ScrollView style={productDetailsStyles.container} nestedScrollEnabled={true}>
					<View style={productDetailsStyles.container}>
						...
						<View style={productDetailsStyles.ingredientContainer}>
							<Text style={productDetailsStyles.ingredientTitle}>Ingredient:</Text>
							<Text style={productDetailsStyles.ingredientContent}>{route.params.EntityDTO.Ingredients.length == 0 ? <Text>Not listed ingredients</Text> : renderIngredient()}</Text>
						</View>
						...
						<View style={productDetailsStyles.noteContainer}>
							...
							<TextInput multiline maxLength={100} style={productDetailsStyles.noteInput} placeholder="Enter note for waiters" onChangeText={(val) => setNote(val)} />
						</View>
