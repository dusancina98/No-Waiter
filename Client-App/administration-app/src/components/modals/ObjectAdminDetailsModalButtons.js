...
const ObjectAdminDetailsModalButtons = ({ handleDelete }) => {
	...
	return (
		<React.Fragment>
			...
			<button className="btn btn-danger mt-2" style={{ background: colorConstants.COLOR_RED, borderColor: colorConstants.COLOR_RED }} onClick={handleDelete}>
				Delete
			</button>
		</React.Fragment>
	);
