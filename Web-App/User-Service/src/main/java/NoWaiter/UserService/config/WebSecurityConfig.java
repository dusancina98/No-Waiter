package NoWaiter.UserService.config;
...
import NoWaiter.UserService.security.auth.RestAuthenticationEntryPoint;
import NoWaiter.UserService.security.auth.TokenAuthenticationFilter;
import NoWaiter.UserService.services.implementation.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
				...
				.authorizeRequests().antMatchers("/api/users/**").permitAll().antMatchers("/h2-console/**").permitAll().antMatchers("/api/foo").permitAll().and()
