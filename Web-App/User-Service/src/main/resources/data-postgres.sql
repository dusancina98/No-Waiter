...
-- restoran admin
insert into users (id, email, name,password,surname,active) values ('22793162-52d3-11eb-ae93-0242ac130111','example1@example.com','Djura','$2a$10$sqes3IpPL4mBgAAmimisyOWj5DlqPRndrJFNFw9zWiJjyNa5ozKS6','Djuric',false);
